        ...
        <div class="max-w-7xl mx-auto mt-8">
            ...
            <form method="POST" action="{{ route('car-models.update', $carModel) }}">
                ...
                <div class="flex items-center justify-start mt-4 gap-x-2">
                    ...
                    <a class="px-6 py-2 text-sm font-semibold text-gray-100 bg-gray-400 rounded-md shadow-md hover:bg-gray-600 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300" href="{{ route('car-models.index') }}">
                        Назад
                    </a>
                </div>
            </form>
